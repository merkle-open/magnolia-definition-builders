 ...
 * @author Merkle DACH
 */
public class AssetLinkDefinitionBuilder extends AbstractLinkFieldDefinitionBuilder<Item, LinkFieldDefinition<Item>, AssetLinkDefinitionBuilder> {

	public AssetLinkDefinitionBuilder() {
		super(DamLinkFieldDefinition::new);
	}

	public LinkFieldDefinition<Item> build(final String name) {
