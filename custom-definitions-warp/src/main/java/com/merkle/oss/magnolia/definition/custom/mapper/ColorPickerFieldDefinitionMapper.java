...
public class ColorPickerFieldDefinitionMapper extends ConfiguredFieldDefinitionMapper<ColorPickerFieldDefinition, JSFieldProperty.JSFieldPropertyBuilder<?, ?>> {
    ...
    @Inject
    public ColorPickerFieldDefinitionMapper(final FormDefinitionProblemUtil formDefinitionProblemUtil, final RequestUtil requestUtil) {
    ...
    @Override
    public JSFieldProperty.JSFieldPropertyBuilder<?, ?> addFieldProperties(final ColorPickerFieldDefinition fieldDefinition, final JSFieldProperty.JSFieldPropertyBuilder<?, ?> builder) {
        final String fieldScript = requestUtil.getContextPath() + "/.resources/custom-definitions-warp/webresources/colorPickerField/index.html";
